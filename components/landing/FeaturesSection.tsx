    ...
    >
      <div className="mx-auto max-w-4xl px-6 md:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 flex flex-col items-center">
          <h2 className="text-xs font-bold uppercase tracking-wider text-neutral-400 dark:text-neutral-500 mb-3">Protocol Features</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {FEATURES.map((feature, idx) => (
            ...
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-xs transition-transform duration-300 hover:rotate-6">
                {renderIcon(feature.icon)}
              </div>
              <div className="flex-1 flex flex-col gap-2">
                <h3 className="text-base font-bold text-black dark:text-white">{feature.title}</h3>
